...
public final class SeparationGroundBuilding {
     ...
     * error, the block is not taken as a ground. This error is in the scale used
     ...
     */
    public static final double ANGLE_GROUND_ERROR = 8;
     ...
     * degrees.
     */
    public static final double LARGE_ANGLE_GROUND_ERROR = 60;
     ...
     */
    public static final double BLOCK_GROUNDS_SIZE_ERROR = 50;
