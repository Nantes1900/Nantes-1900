...
public class GlobalTreeController
{
     ...
     */
    public GlobalTreeController(IsletSelectionController isletSelectionController)
    {
    ...
    public void updateDirectory(File newDirectory)
    {
        ...
        // pour vérifier que tout se passe bien. A enlever quand le visuel sera mis en place.
