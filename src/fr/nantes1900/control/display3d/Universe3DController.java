        ...
        } else
        {
            ...
            if (this.lockMode == LOCK_MODE)
            {
                ...
                if (this.surfaceLocked != surfacePicked)
                {
                    ...
                    if(!this.surfaceLocked.getNeighbours().contains(surfacePicked))
...
//     */
//    public boolean
//            includeNeighbour(Surface surfaceLocked, Surface surfacePicked) {
//
//        for (Surface neigbhour : surfaceLocked.getNeighbours())
//        {
//            return neigbhour == surfacePicked;
//        }
//        return false;
//    }
