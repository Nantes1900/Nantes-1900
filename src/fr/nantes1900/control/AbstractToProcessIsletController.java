...
import fr.nantes1900.models.islets.buildings.AbstractToProcessIslet.UnimplementedException;
import fr.nantes1900.view.AbstractToProcessIsletView;

public abstract class AbstractToProcessIsletController {
    private AbstractToProcessIsletView isletView;
    private AbstractToProcessIslet islet;

    public AbstractToProcessIsletController(
	    AbstractToProcessIslet isletIn,
	    AbstractToProcessIsletView isletViewIn) {
	this.isletView = isletViewIn;
	this.islet = isletIn;
    }

    public AbstractToProcessIsletView getIsletView() {
	return this.isletView;
    }

    public AbstractToProcessIslet getIslet() {
	return this.islet;
    }
