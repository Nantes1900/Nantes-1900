...
public class NavigationBarView extends JPanel
{
    ...
    protected JLabel title = new JLabel(FileTools.readElementText(TextsKeys.KEY_PROCESSTITLE+"1"));
    ...
    public void refreshStepTitle(int i){
        this.title.setText(FileTools.readElementText(TextsKeys.KEY_PROCESSTITLE+i));
        this.title.repaint();
    }
}
