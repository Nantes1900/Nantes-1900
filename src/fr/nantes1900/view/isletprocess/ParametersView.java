...
{   //FIX ME
    ...
    public ParametersView(){
        ...
        this.value4 = new ValueProperty(SeparationGroundBuilding.getBlockGroundsSizeError());
        this.property5 = new JLabel("BlockBuildingSize");
        this.property5.setPreferredSize(this.labelDimension); 
        this.value5 = new ValueProperty(SeparationBuildings.getBlockBuildingSize());
    ...
    public void displayParameters(int i){
        ...
        switch (i) {
            case 1 : this.displayOneParameter(0, 0, 1);
            this.displayOneParameter(0, 1, 2);
            this.displayOneParameter(0, 2, 3);
            this.displayOneParameter(0, 3, 4);
            break;
            case 2 : this.displayOneParameter(0, 0, 5); break;
            case 3 : this.displayOneParameter(0, 0, 6); break;
            default : break;
            }
    }
    ...
    private void displayOneParameter(int x, int y, int n){
        switch (n) {
            case 1 :this.add(property1, new GridBagConstraints(x,y,1,1,10.0,10.0,GridBagConstraints.CENTER,
                        GridBagConstraints.HORIZONTAL,
                        new Insets(8,8,8,8),0,0));
                    this.add(value1, new GridBagConstraints(x+1,y,1,1,10.0,10.0,GridBagConstraints.CENTER,
                            GridBagConstraints.HORIZONTAL,
                            new Insets(8,8,8,8),0,0));
                    break;
            case 2 :this.add(property2, new GridBagConstraints(x,y,1,1,10.0,10.0,GridBagConstraints.CENTER,
                    GridBagConstraints.HORIZONTAL,
                    new Insets(8,8,8,8),0,0));
                this.add(value2, new GridBagConstraints(x+1,y,1,1,10.0,10.0,GridBagConstraints.CENTER,
                        GridBagConstraints.HORIZONTAL,
                        new Insets(8,8,8,8),0,0));
                break;
            case 3 :this.add(property3, new GridBagConstraints(x,y,1,1,10.0,10.0,GridBagConstraints.CENTER,
                    GridBagConstraints.HORIZONTAL,
                    new Insets(8,8,8,8),0,0));
                this.add(value3, new GridBagConstraints(x+1,y,1,1,10.0,10.0,GridBagConstraints.CENTER,
                        GridBagConstraints.HORIZONTAL,
                        new Insets(8,8,8,8),0,0));
                break;
            case 4 :this.add(property4, new GridBagConstraints(x,y,1,1,10.0,10.0,GridBagConstraints.CENTER,
                    GridBagConstraints.HORIZONTAL,
                    new Insets(8,8,8,8),0,0));
                this.add(value4, new GridBagConstraints(x+1,y,1,1,10.0,10.0,GridBagConstraints.CENTER,
                        GridBagConstraints.HORIZONTAL,
                        new Insets(8,8,8,8),0,0));
                break;
            case 5 :this.add(property5, new GridBagConstraints(x,y,1,1,10.0,10.0,GridBagConstraints.CENTER,
                    GridBagConstraints.HORIZONTAL,
                    new Insets(8,8,8,8),0,0));
                this.add(value5, new GridBagConstraints(x+1,y,1,1,10.0,10.0,GridBagConstraints.CENTER,
                        GridBagConstraints.HORIZONTAL,
                        new Insets(8,8,8,8),0,0));
                break;
            case 6 :this.add(property6, new GridBagConstraints(x,y,1,1,10.0,10.0,GridBagConstraints.CENTER,
                    GridBagConstraints.HORIZONTAL,
                    new Insets(8,8,8,8),0,0));
                this.add(value6, new GridBagConstraints(x+1,y,1,1,10.0,10.0,GridBagConstraints.CENTER,
                        GridBagConstraints.HORIZONTAL,
                        new Insets(8,8,8,8),0,0));
                break;
                default : break;
    ...
    public void enableChanges(int i){
        switch(i){
            case 1 : this.value1.setEnabled(true);
            this.value2.setEnabled(true);
            this.value3.setEnabled(true);
            this.value4.setEnabled(true);
            break;
            case 2 : this.value5.setEnabled(true); break;
            case 3 : this.value6.setEnabled(true); break;
            case 4 : this.value7.setEnabled(true);
            ...
            break;
            case 5 : this.value14.setEnabled(true); break;
            default : break;
        }
    }
