	...
	public static void main(String[] args) {
		try {
			...
			while(new File("batiment - " + compt + " - toit - " + compteurToit + ".stl").exists()) {
				Mesh toit = new Mesh(Parser.readSTLA("batiment - " + compt + " - toit - " + compteurToit + ".stl"));
				toits.add(toit);
				compteurToit++;
			}
			...
			while(new File("batiment - " + compt + " - mur - " + compteurBat + ".stl").exists()) {
				...
				Mesh mur = new Mesh(Parser.readSTLA("batiment - " + compt + " - mur - " + compteurBat + ".stl"));
				batiment.add(mur);
				...
				Writer.writeSTLA("contour" + compteurBat + ".stl", contour);
				...
				Writer.writeSTLA("faceBienOrientee" + compteurBat + ".stl", faceBienOrientee);
