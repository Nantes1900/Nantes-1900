...
public class SurfaceTest extends TestCase
{
     ...
     */
    @Test
    public final static void testFindEdges()
    {
        try
        {
            ...
            final Polyline p = m5.findEdges(wallList, pointMap, new Vector3d(0,
                    0, 1));
     ...
     */
    @Test
    public final static void testOrderNeighbours()
    {
     ...
     */
    @Test
    public final static void testReturnNeighbours()
    {
        final Vector3d normal = new Vector3d(0, 0, 1);
        final Point p1 = new Point(1, 1, 0);
        final Edge e1 = new Edge(p1, p1);
     ...
     */
    @Test
    public final static void testReturnVerticalPlane()
    {
